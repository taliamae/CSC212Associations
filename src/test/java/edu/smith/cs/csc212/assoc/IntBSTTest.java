...
import edu.smith.cs.csc212.assoc.IntBST;
import edu.smith.cs.csc212.assoc.IntBST.BSTNode;
...
public class IntBSTTest {
	...
	public void testInsert() {
		...
		assertEquals(tree.root, new BSTNode(4, new BSTNode(2), new BSTNode(5)));
	}

	@Test
	public void testMaxMin() {
		IntBST tree = new IntBST(new BSTNode(4, new BSTNode(2), new BSTNode(5)));
	...
	public void testHeightLeaf() {
		BSTNode leaf = new BSTNode(7);
		assertEquals(1, leaf.getHeight());
	}

	@Test
	public void testHeightLeft() {
		BSTNode leaf = new BSTNode(7, new BSTNode(7), null);
		assertEquals(2, leaf.getHeight());
	}

	@Test
	public void testHeightRight() {
		BSTNode leaf = new BSTNode(7, null, new BSTNode(7));
		assertEquals(2, leaf.getHeight());
	}
	...
	public void testRemoveL() {
		IntBST tree = new IntBST(new BSTNode(4, new BSTNode(2), new BSTNode(5)));
		tree.remove(2);
		IntBST expected = new IntBST(new BSTNode(4, null, new BSTNode(5)));
	...
	public void testRemoveR() {
		IntBST tree = new IntBST(new BSTNode(4, new BSTNode(2), new BSTNode(5)));
		tree.remove(5);
		IntBST expected = new IntBST(new BSTNode(4, new BSTNode(2), null));
		assertEquals(expected, tree);
	}
	...
	public void testRemoveRoot() {
		IntBST tree = new IntBST(new BSTNode(4, new BSTNode(2), new BSTNode(5)));
		tree.remove(4);
		IntBST expected = new IntBST(new BSTNode(5, new BSTNode(2), null));
		assertEquals(expected, tree);
	}
